    ...
    try {
        ...
        <div style="font-family:Arial,sans-serif;max-width:420px;margin:auto;background:#0d0d0f;border-radius:16px;overflow:hidden;">
          ...
          <div style="background:#ffffff;padding:24px;">
            ...
            <div style="background:#fafafa;border:1px solid #eee;border-radius:12px;padding:16px;margin:20px 0 16px;font-size:12.5px;color:#2c2c2e;line-height:1.6;">
              <p style="margin:0 0 10px;font-weight:700;font-size:13.5px;color:#0d0d0f;display:flex;align-items:center;">
                🎟️ Ticket Guidelines
              </p>
              <ul style="margin:0;padding-left:16px;color:#444;">
              ...
              <p style="margin:10px 0 0;font-weight:800;font-size:12px;text-transform:uppercase;letter-spacing:.05em;color:#b91c1c;">
